...
@XmlSeeAlso({ CmisPropertyHtml.class, CmisPropertyDecimal.class,
		CmisPropertyDateTime.class, CmisPropertyId.class,
		CmisPropertyString.class, CmisPropertyUri.class,
		CmisPropertyBoolean.class, CmisPropertyInteger.class })
