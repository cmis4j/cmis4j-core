...
@XmlType(name = "", propOrder = { "repositoryId", "objectId", "isLastChunk",
		"changeToken", "contentStream", "extension" })
@XmlRootElement(name = "appendContentStream")
public class AppendContentStream {

	@XmlElement(required = true)
	protected String repositoryId;
	@XmlElement(required = true)
	protected String objectId;
	@XmlElementRef(name = "isLastChunk", namespace = "http://docs.oasis-open.org/ns/cmis/messaging/200908/", type = JAXBElement.class, required = false)
	protected JAXBElement<Boolean> isLastChunk;
	 ...
	 * 
	 * @return possible object is {@link JAXBElement }{@code <}{@link Boolean }
	 *         {@code >}
	 * 
	 */
	public JAXBElement<Boolean> getIsLastChunk() {
		return isLastChunk;
	}
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link JAXBElement }{@code <}{@link Boolean }
	 *            {@code >}
	 * 
	 */
	public void setIsLastChunk(JAXBElement<Boolean> value) {
	 ...
	 * 
	 * @return possible object is {@link CmisContentStreamType }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link CmisContentStreamType }
	 * 
	 */
