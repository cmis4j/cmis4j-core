 ...
 *         &lt;element name="canCreateItem" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/>
...
@XmlType(name = "cmisAllowableActionsType", propOrder = { "canDeleteObject",
		"canUpdateProperties", "canGetFolderTree", "canGetProperties",
		"canGetObjectRelationships", "canGetObjectParents",
		"canGetFolderParent", "canGetDescendants", "canMoveObject",
		"canDeleteContentStream", "canCheckOut", "canCancelCheckOut",
		"canCheckIn", "canSetContentStream", "canGetAllVersions",
		"canAddObjectToFolder", "canRemoveObjectFromFolder",
		"canGetContentStream", "canApplyPolicy", "canGetAppliedPolicies",
		"canRemovePolicy", "canGetChildren", "canCreateDocument",
		"canCreateFolder", "canCreateRelationship", "canCreateItem",
		"canDeleteTree", "canGetRenditions", "canGetACL", "canApplyACL", "any" })
