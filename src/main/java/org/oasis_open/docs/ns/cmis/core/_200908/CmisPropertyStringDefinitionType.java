...
@XmlType(name = "cmisPropertyStringDefinitionType", propOrder = {
		"defaultValue", "maxLength", "choice" })
public class CmisPropertyStringDefinitionType extends
	 ...
	 * 
	 * @return possible object is {@link CmisPropertyString }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link CmisPropertyString }
	 * 
	 */
