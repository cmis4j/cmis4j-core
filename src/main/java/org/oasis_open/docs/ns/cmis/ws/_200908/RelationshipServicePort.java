...
public interface RelationshipServicePort {
	...
	public org.oasis_open.docs.ns.cmis.messaging._200908.CmisObjectListType getObjectRelationships(
			...
			@WebParam(name = "includeSubRelationshipTypes", targetNamespace = "http://docs.oasis-open.org/ns/cmis/messaging/200908/") java.lang.Boolean includeSubRelationshipTypes,
			@WebParam(name = "relationshipDirection", targetNamespace = "http://docs.oasis-open.org/ns/cmis/messaging/200908/") org.oasis_open.docs.ns.cmis.core._200908.EnumRelationshipDirection relationshipDirection,
