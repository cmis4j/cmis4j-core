...
@XmlType(name = "cmisPropertyHtmlDefinitionType", propOrder = { "defaultValue",
		"choice" })
public class CmisPropertyHtmlDefinitionType extends CmisPropertyDefinitionType {
	 ...
	 * 
	 * @return possible object is {@link CmisPropertyHtml }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link CmisPropertyHtml }
	 * 
	 */
