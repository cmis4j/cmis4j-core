...
@XmlSeeAlso({ CmisChoiceHtml.class, CmisChoiceInteger.class,
		CmisChoiceDecimal.class, CmisChoiceString.class,
		CmisChoiceDateTime.class, CmisChoiceId.class, CmisChoiceBoolean.class,
		CmisChoiceUri.class })
