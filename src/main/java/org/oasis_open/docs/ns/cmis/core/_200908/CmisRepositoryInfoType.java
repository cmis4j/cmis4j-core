...
@XmlType(name = "cmisRepositoryInfoType", propOrder = { "repositoryId",
		"repositoryName", "repositoryDescription", "vendorName", "productName",
		"productVersion", "rootFolderId", "latestChangeLogToken",
		"capabilities", "aclCapability", "cmisVersionSupported",
		"thinClientURI", "changesIncomplete", "changesOnType",
		"principalAnonymous", "principalAnyone", "extendedFeatures", "any" })
public class CmisRepositoryInfoType {
	 ...
	 * 
	 * @return possible object is {@link CmisRepositoryCapabilitiesType }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link CmisRepositoryCapabilitiesType }
	 * 
	 */
	 ...
	 * 
	 * @return possible object is {@link CmisACLCapabilityType }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link CmisACLCapabilityType }
	 * 
	 */
	 ...
	 * <CODE>set</CODE> method for the changesOnType property.
	 * 
	 * <p>
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the extendedFeatures property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 ...
	 * <p>
	 * Objects of the following type(s) are allowed in the list
	 * {@link CmisExtensionFeatureType }
	 * 
	 * 
	 */
	public List<CmisExtensionFeatureType> getExtendedFeatures() {
		if (extendedFeatures == null) {
			extendedFeatures = new ArrayList<CmisExtensionFeatureType>();
		}
