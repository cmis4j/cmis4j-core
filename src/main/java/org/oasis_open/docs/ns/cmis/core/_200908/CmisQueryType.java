...
@XmlType(name = "cmisQueryType", propOrder = { "statement",
		"searchAllVersions", "includeAllowableActions", "includeRelationships",
		"renditionFilter", "maxItems", "skipCount", "any" })
public class CmisQueryType {
	 ...
	 * 
	 * @return possible object is {@link EnumIncludeRelationships }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link EnumIncludeRelationships }
	 * 
	 */
